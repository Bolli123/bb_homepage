...
const AboutMe = () => {
  ...
  React.useEffect(() => {
    const fetchFavorites = async () => {
      await fetch('https://api.bjornbreki.is/getFavorites')
        ...
        <h1 className="header aboutIntro">Hey!</h1>
          ...
          <div className="aboutMusic">
            <div>
              ...
              <SpotifyFrame favorite={favorites.track}/>
            </div>
            <div>
              <div className="spotifyFrameInfo">Artist</div>
              <SpotifyFrame favorite={favorites.artist}/>
            </div>
            <div>
              <div className="spotifyFrameInfo">Album</div>
              <SpotifyFrame favorite={favorites.album}/>
            </div>
          </div>
        </div>
      </div>
